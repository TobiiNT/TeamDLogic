...
public class Application {
    ...
    public static void main(String[] args) throws IOException {
        try
        {
            ...
            InitializeGetPlayerBookingContext();
            InitializeGetBookingInfoContext();
    ...
    public static void InitializeGetAvalableSlotContext() {
        GetAvalableSlotInCenterHandler GetAvalableSlotHandler = new GetAvalableSlotInCenterHandler("GET", ObjectMapper, GlobalExceptionHandler);
    ...
    public static void InitializeGetBookingInfoContext() {
        GetBookingInfoHandler GetBookingInfoHandler = new GetBookingInfoHandler("GET", ObjectMapper, GlobalExceptionHandler);
        httpServer.createContext("/api/users/getbookinginfo", GetBookingInfoHandler::Handle);
        System.out.println("Initialize GetBookingInfo Context.");
    }
    ...
    public static void InitializeGetPlayerBookingContext() {
        GetPlayerBookingHandler GetPlayerBookingHandler = new GetPlayerBookingHandler("GET", ObjectMapper, GlobalExceptionHandler);
        httpServer.createContext("/api/users/getplayerbooking", GetPlayerBookingHandler::Handle);
        System.out.println("Initialize GetPlayerBooking Context.");
    }
}
