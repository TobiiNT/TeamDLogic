...
public class CancelBookingHandler extends Handler {
    ...
    @Override
    protected ResponseEntity<CancelBookingResponse> DoPost(String Input) {
        CancelBookingRequest CancelBookingRequest = ReadRequest(Input, CancelBookingRequest.class);
