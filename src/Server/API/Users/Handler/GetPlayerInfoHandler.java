...
public class GetPlayerInfoHandler extends Handler {
    ...
    @Override
    protected ResponseEntity<GetPlayerInfoResponse> DoPost(String Input) {
        GetPlayerInfoRequest GetPlayerInfoRequest = ReadRequest(Input, GetPlayerInfoRequest.class);
