...
public class CreateCityCenterCourtHandler extends Handler {
    ...
    @Override
    protected ResponseEntity<CreateCityCenterCourtResponse> DoPost(String Input) {
        CreateCityCenterCourtRequest CreateCityCenterCourtRequest = ReadRequest(Input, CreateCityCenterCourtRequest.class);
